interface RPCCollection {[key: string]: RTCPeerConnection}
interface StreamCollection {[key: string]: MediaStream}

var myRPCs: RPCCollection = {};
var myStreams: StreamCollection = {};
...
function getRPC(emitter, remoteAgentName) {
    ...
    if(rpc===undefined) {
        ...
        (rpc as any).ontrack = e=>setupStream(e.streams[0], remoteAgentName);
